...
function faq1() {
    ...
    if (p == 1) {
        ...
        document.getElementById("para1").innerText = "Your Mahindra car will be covered by comprehensive insurance, to take care of damage cases. On every case of damage, your liability would be limited to the difference between the costs incurred to repair the damage and the proceeds from insurance claim with maximum liability limited to INR 10,000 In situations of irresponsible or unsafe or negligent usage, there could be discretionary exceptions to this policy, whereby you could be liable for all damages irrespective of whether or not we are able to claim insurance in such cases."
        p = 2;
    }
    else if (p == 2) {
...
function faq2() {
    ...
    if (q == 1) {
        x.setAttribute("src", "./icons/minus-icon.png");
        document.getElementById("para2").innerText = "Yes, you can extend the car anytime at normal prices or chose to return the car anytime by just paying the fee difference."
        q = 2;
    }
    else if (q == 2) {
        x.setAttribute("src", "./icons/plus-icon.png");
...
function faq3() {
    ...
    if (r == 1) {
        x.setAttribute("src", "./icons/minus-icon.png");
        document.getElementById("para3").innerText = "You can use the Mahindra car for all the normal requirements. However, abnormal usage like speed racing, towing/pushing/propelling, transportation of goods or people on commercial basis, transportation of large/heavy/hazardous items are not allowed."
        r = 2;
    }
    else if (r == 2) {
        x.setAttribute("src", "./icons/plus-icon.png");
...
function faq4() {
    ...
    if (s == 1) {
        x.setAttribute("src", "./icons/minus-icon.png");
        document.getElementById("para4").innerText = "No upfront payments such as down payment or road tax, flexibility of subscribing for min. 1 month and extending or returning anytime, insurance and maintenance included in monthly fees, 24X7 road side assistance and hassle free service & maintenance are just a few benefits of Revv Mahindra Subscriptions."
        s = 2;
    }
    else if (s == 2) {
        x.setAttribute("src", "./icons/plus-icon.png");
